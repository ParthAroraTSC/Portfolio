...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            skills: ["SOC-Operations", "Incident-Response", "VAPT", "Network-Security", "DevSecOps", "SIEM", "Python"],
            projects: ["pixelmovies", "winoraa-global", "opera-homes", "webrora-studios", "manan-rajkhowa", "cosydiscord"],
            interests: ["Cybersecurity", "Ethical Hacking", "Cloud Security"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">parth@Dell</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/parth")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-parth, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-parth":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-parth");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-parth, todoist, trash, settings, sendmsg ]";
                }
                break;
